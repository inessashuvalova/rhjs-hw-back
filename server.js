...
serverEng.use(koaBody({ urlencoded: true, multipart: true }));
...
serverEng.use(router.routes()).use(router.allowedMethods());

module.exports = serverEng;